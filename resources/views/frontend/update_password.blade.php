        ...
        <div id="main-wrapper">                  <div class="home-nav">
          ...
          <a class="topbartoggler d-block d-md-none waves-effect waves-light" href="javascript:void(0)"
              data-toggle="collapse" data-target="#navbarSupportedContent"
                  ...
                  <button type="button" class="btn homenav-btn" data-toggle="modal"
                      data-target="#login-modal">LOGIN</button>
                      
                      <button type="button" class="btn homenav-btn-border" data-toggle="modal"
...
<!-- ***************modal for Sign In end********** -->
      ...
      <div class="page-wrapper">      <div class="container-fluid">     <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url() no-repeat center center; background-size: cover;">
    <div class="auth-box p-4 bg-white rounded">
      ...
      <script type="text/javascript">
        var require = {
          baseUrl: '/',        urlArgs: 'a40e5a35',          deps: [    "js/component/PageMsg",
    "js/component/UserProfile",
],
          config: {
              'js/component/Application':{"Level":{"Level":"Live"},"StaticDomain":"http:\/\/static.noriapay.com","Page_MsgErrors":[],"Page_MsgInfo":[],"Page_MsgWarning":[],"Page_MsgSuccess":[]},
          }
        };          
        </script>
        <script src='/js/require.js'></script>
        <script src="http://localhost:8000/assets/frontend/js/frontend_js/forgetpassword.js"></script>
    </body>
  </html>