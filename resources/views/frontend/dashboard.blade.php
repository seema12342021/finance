...
<!-- ***************modal for Sign In end********** -->
   ...
   <div class="welcome-section-dashboard">
     <p ><span class="day-message"></span>, Ashu</p>
  </div>
                                        ...
                                        <form class="pl-3 pr-3" method="POST">
                                             <h3>Payment Methods</h3>
                                                ...
                                                <div class="inputParent">
                                                    ...
                                                    <div class="inputBox">
                                                        <div class="input_label">
                                                            ...
                                                            <input onkeypress="multiply()" class="error" name="form_crypto_amount" value="100" type="text" id="form_crypto_amount_buy">
                                                ...
                                                <div class="exChange mb-3">
                                                    <button type="submit" onkeypress="divide()" id="BuyExchange">Exchange</button>
