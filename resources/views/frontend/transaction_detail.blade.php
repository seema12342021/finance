<!DOCTYPE html>
    <html>
      <head>
        ...
        <title>NoriaPay > Transaction Details</title>
        ...
        <!--WIDGET_CSS-->    	    <link href="" rel='stylesheet' />
      <style type="text/css">
...
<div class="main-container" >
    ...
    "js/component/UserProfile",
          ...
          config: {
              'js/component/Application':{"Level":{"Level":"Live"},"User":{"u_name":"mailtoashusingh1@gmail.com","f_name":"Ashu","u_id":1127},"StaticDomain":"http:\/\/static.noriapay.com","Page_MsgErrors":[],"Page_MsgInfo":[],"Page_MsgWarning":[],"Page_MsgSuccess":[]},    'js/component/UserTransactions':{"transaction_id":1041,"transaction_type":"SELL"},
          }
        };            $('#dashboard').DataTable({
      "searching": false
});
